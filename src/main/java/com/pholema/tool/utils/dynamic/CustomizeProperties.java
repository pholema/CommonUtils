...
/**
 * copy of java.util.Properties. usage of LinkedHashMap
 * no XMLSupport(), save() function
 *
 */
public class CustomizeProperties extends LinkedHashMap<Object,Object> {
    /**
     ...
     * @serial
     */
    protected CustomizeProperties defaults;
     ...
     */
    public CustomizeProperties(CustomizeProperties defaults) {
